...
/*
This test file is part of the viautil package rather than than the
viautil_test package so it can bridge access to the internals to properly test
...
// P2PKH and P2SH viacoin addresses.
...
// bech32 encoded P2WPKH and P2WSH viacoin addresses.
