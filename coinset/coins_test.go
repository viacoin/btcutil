...
import (
	...
	"github.com/viacoin/viautil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    viautil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() viautil.Amount { return c.TxValue }
...
func NewCoin(index int64, value viautil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = viautil.Amount(3500000)
	...
	testSimpleCoinTx, _               = viautil.NewTxFromBytes(testSimpleCoinTxBytes)
